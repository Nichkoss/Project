...
def upgrade() -> None:
    ...
    op.create_table('additional_passenger',
    ...
    sa.Column('mgr', sa.Boolean(), nullable=True),
    sa.Column('firstname', sa.String(length=50), nullable=False),
    sa.Column('lastname', sa.String(length=50), nullable=False),
    sa.Column('birthdate', sa.Date(), nullable=False),
    sa.Column('pass_ser', sa.String(length=50), nullable=False),
    ...
    op.create_table('sit',
    sa.Column('idsit', sa.Integer(), nullable=False),
    sa.Column('sitnumber', sa.Integer(), nullable=False),
    sa.Column('available', sa.Boolean(), nullable=False),
    sa.Column('price', sa.Float(), nullable=False),
    sa.Column('flightid', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['flightid'], ['flight.idflight'], ),
    sa.PrimaryKeyConstraint('idsit')
    )
    ...
    sa.Column('sitid', sa.Integer(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['passengerid'], ['additional_passenger.idpassenger'], ),
    sa.ForeignKeyConstraint(['sitid'], ['sit.idsit'], ),
...
def downgrade() -> None:
    ...
    op.drop_table('additional_passenger')
    # ### end Alembic commands ###
